...
public class StringBuilder01 {
    ...
    /*
        ...
        2)Question: We have "String Class" to create "Strings", why did Java create
        "StringBuilder" class to create "Strings"?
                    "String Class" is "Immutable", we sometimes need "Mutable Strings"
                    that is why Java created "StringBuilder" class
        ...
        4)If you need a String to use in "multi thread" use "StringBuffer"
          ...
          ii)StringBuilder Class: If you need "mutable String" and do not need "multi thread" and
          "synchronization" use
                                  StringBuilder Class to create a String.
          iii)StringBuffer Class:  If you need "mutable String" and "multi thread" and
           "synchronization" use
    ...
    public static void main(String[] args) {
        ...
        //Java creates a new container for the updated value and puts the updated
        // value in the new container.
        String t = s.concat("!");
        ...
        // do not forget to mention about reverse() method
        //in StringBuilder Class.
        sb1.reverse();
        System.out.println(sb1);//...! si avaJ

        //toString(); is for converting "StringBuilder" to "String", but toString();
