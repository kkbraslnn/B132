...
public abstract class Animal {
     /*
        ...
        6)To make a method abstract
            ...
            iii)Change the "concrete class" to "abstract class" by using abstract keyword between
         ...
         10)An "abstract class" cannot be "final" because; final class cannot have child classes but
         abstract class should have child classes
            to make "abstract method"s to be implemented in child classes.
         11)"abstract class"es can have "abstract methods", "abstract methods" are "uncompleted methods"
         because they do not have body part.
          ...
          12)"abstract class"es are classes, so they have "constructor" like other classes but
           the constructor cannot create object.
          13)We create "abstract method" for the child classes to use, but if you make the
           access modifier "private" it means
